...
//        .on('error', errorLogger) // more verbose and dupe output. requires emit.
        .pipe(gulp.dest(config.temp + 'scss'));
});
...
//        .on('error', errorLogger) // more verbose and dupe output. requires emit.
        ...
        .pipe(gulp.dest(config.temp + 'less'));
});
...
function startBrowserSync(isDev, specRunner) {
    ...
    if (isDev) {
        gulp.watch([config.less, config.scss], ['styles'])
            .on('change', changeEvent);
    } else {
        gulp.watch([config.less, config.scss, config.js, config.html],
